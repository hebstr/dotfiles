...
- The remaining translations (`relire`, `depouiller`, `zotero`; `commit` and its verifier were translated and fidelity-reviewed on 2026-09-24, `cfb3a40`) are listed in `~/dotfiles/.claude/DESIGN-CADRER.md`, which now records this standard.
