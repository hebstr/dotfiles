...
description: Positron's per-profile extensions.json is the authoritative registry for the active profile; the global one lags. Never delete extension folders judged orphan by the global registry alone.
metadata:
  type: reference
---
