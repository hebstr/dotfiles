...
- `find 2>/dev/null` in the non-git fallback of the directory listing as hiding partial results — runs in user's own project directory (inside git the listing is `git ls-files`, since 2026-09-19)
